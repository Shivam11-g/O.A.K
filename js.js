...
function linkTableAnimation(){
  var a= document.getElementsByClassName("linkAnimation");
  var i;
if (flag>0) {
    for ( i = 0; i < a.length; i++) {
    a[i].style.animation="reverseAnimation 0.5s";
    a[i].style.left='-625px';
    }
    flag=0;
  }
else{
    for ( i = 0; i < a.length; i++) {
    a[i].style.animation="linkanimi 0.5s";
    a[i].style.left='150px';
    }
    flag=1;
  }
}
